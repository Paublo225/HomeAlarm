...
class PlatformChannel extends StatefulWidget {
  List<dynamic> tr = [];
  List<bool> boolShit = [];
  PlatformChannel({Key key, this.tr, this.boolShit}) : super(key: key);
  @override
          ...
          child: Row(children: <Widget>[
            Expanded(
              child: Padding(
                  ...
                  child: Center(
                      child: Text('Разрешите приложению доступ к Дому',
